...
public class ExcelUtils {
	...
	public static String getCellData(String xlfile, String xlsheet, int rownum, int columnnum) throws IOException {
		...
		try {
			...
			// Returns the formated value of a cell as a string regardless of the cell type.
			data = formatter.formatCellValue(cell);
		} catch (Exception e) {
			// sets empty data to the cell values which are null or blank
			data = "";
		}
	...
	public static void fillGreenColor(String xlfile, String xlsheet, int rownum, int columnnum) throws IOException {
		fi = new FileInputStream(xlfile);
		wb = new XSSFWorkbook(fi);
		ws = wb.getSheet(xlsheet);
		row = ws.getRow(rownum);
